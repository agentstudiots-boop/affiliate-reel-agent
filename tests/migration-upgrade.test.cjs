...
test('006–015 upgrade populated 001–005 once without replaying or changing prior migrations', async () => {
  const pg = new PGlite();
  const db = {
