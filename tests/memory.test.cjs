...
test('explicit migrations are transactional and idempotent',async()=>{
  ...
  try{
    ...
    assert.deepEqual(first,{applied:['001_memory.sql','002_production_gates.sql','003_faceless_so.sql','004_daily_drafts.sql','005_publication_gate.sql'],alreadyApplied:[]});
    assert.deepEqual(second,{applied:[],alreadyApplied:['001_memory.sql','002_production_gates.sql','003_faceless_so.sql','004_daily_drafts.sql','005_publication_gate.sql']});
